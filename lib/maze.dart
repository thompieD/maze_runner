...
class Maze extends Component {
  ...
  Future<void> onLoad() async {
    ...
    // Initialize the dungeon layout with walls
  ...
  void _generateDungeon() {
    ...
    // Ensure the dungeon dimensions are sufficient
  ...
  // Check if a position overlaps with any room except the given rooms
  ...
  // Add a wall or corner tile based on its surroundings
